...
GameBoyCore.prototype.ROMLoad = function() {
  ...
  this.usedBootROM =
    this.opts.bootRom &&
    ((!this.opts.gbBootRom && this.GBCBOOTROM.length == 0x800) ||
      (this.opts.gbBootRom && this.GBBOOTROM.length == 0x100));
...
GameBoyCore.prototype.initializeTiming = function() {
  ...
  this.baseCPUCyclesPerIteration =
    (this.clocksPerSecond / 1000) * this.opts.interval;
  ...
  if (this.canvas.setAttribute) {
    this.canvas.setAttribute(
      ...
      (this.canvas.getAttribute("style") || "") +
        "; image-rendering: " +
        (this.opts.imageSmoothing ? "auto" : "-webkit-optimize-contrast") +
        ";" +
        "image-rendering: " +
        (this.opts.imageSmoothing ? "optimizeQuality" : "-o-crisp-edges") +
        ";" +
        "image-rendering: " +
        (this.opts.imageSmoothing ? "optimizeQuality" : "-moz-crisp-edges") +
        ";" +
...
GameBoyCore.prototype.initSound = function() {
  ...
  if (this.opts.sound) {
    var self = this;
    this.audioHandle = new this.opts.sound(
      2,
      this.clocksPerSecond / this.audioResamplerFirstPassFactor,
      0,
      Math.max(
        (this.baseCPUCyclesPerIteration * this.opts.audioBufferMax) /
...
GameBoyCore.prototype.initAudioBuffer = function() {
  ...
  this.bufferContainAmount =
    Math.max(
      (this.baseCPUCyclesPerIteration * this.opts.audioBufferMin) /
        this.audioResamplerFirstPassFactor,
      4096
    ) << 1;
